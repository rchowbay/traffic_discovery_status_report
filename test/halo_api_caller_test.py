...
def add_file_statistics_test(output_directory, file_name, current_time, filter):
    csv_operations_obj = csv_operations.CSVOperations()
    csv_operations_obj.add_file_statistics(
        output_directory, file_name, current_time, filter)


def row_counter_test(output_directory, file_name):
    csv_operations_obj = csv_operations.CSVOperations()
    total_rows, td_enabled_status_rows, td_disabled_status_rows, td_not_set_status_rows = csv_operations_obj.row_counter(
...
if __name__ == "__main__":
    ...
    output_directory = 'C:/Users/tmiller/tmp_output_dir/td_status_report_2023-06-07T12-37-28-006755'
