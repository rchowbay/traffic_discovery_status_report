...
class Utility(object):
    ...
    @classmethod
    def log_stdout(cls, message, component="HALO_GROUP_TD_STATUS_REPORT"):
        """Log messages to stdout.

        Args:
            message(str): Message to be logged to stdout.
            component(str): Component name. Defaults to "HALO_GROUP_TD_STATUS_REPORT".
        """
    ...
    @classmethod
    def log_stderr(cls, message, component="HALO_GROUP_TD_STATUS_REPORT"):
