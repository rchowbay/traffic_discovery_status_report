...
class ConfigHelper(object):
    ...
    Attributes:
        ...
        halo_group_td_status (str): HALO Group TD Status
    ...
    def __init__(self):
        ...
        #self.halo_group_id = os.getenv("HALO_GROUP_ID", "all")
        self.halo_group_id = os.getenv("PINE_HALO_GROUP_ID", "all")
        self.halo_group_td_status = os.getenv("HALO_GROUP_TD_STATUS", "all")
